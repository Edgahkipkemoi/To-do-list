...
**[To do list-setup]** is the second project in week two of Module 2. In this project I setup the To-do-list project.
...
```
$ git clone https://github.com/Edgahkipkemoi/To-do-list.git
```
